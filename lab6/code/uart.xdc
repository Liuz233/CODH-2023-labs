...
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { swx_vld }]; #IO_L5P_T0_D06_14 Sch=led16_b
...
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { seg_rdy }]; #IO_0_14 Sch=led17_g
